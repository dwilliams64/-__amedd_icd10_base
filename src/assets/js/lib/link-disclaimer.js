    ...
    $('a[href$=".pdf"]').each(function() {
        ...
        if (linkPDF) {
            linkPDF.click(function(event) {
                if (!confirm('You are opening an Adobe Acrobat PDF document. It can be viewed in your browser or by using applications that will allow you to view Adobe Acrobat PDF files.')) event.preventDefault();
            })
