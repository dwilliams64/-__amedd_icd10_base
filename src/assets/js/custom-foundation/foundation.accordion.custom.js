...
class Accordion extends Plugin {
  ...
  _init() {
    ...
    this.$tabs.each(function(idx, el) {
      ...
      $content.attr({'role': 'tabpanel', 'aria-labelledby': linkId, 'aria-hidden': true, 'id': id, 'tabindex': 1});
    });
  ...
  _events() {
    ...
    this.$tabs.each(function() {
      ...
      if ($tabContent.length) {
        ...
        var getTabIdx=($tabContent).attr('tabindex')
        setTimeout(function() {
            // $('[role="tabpanel"]').focus();
            $($tabContent).find('a').attr('tabindex',getTabIdx)
        }, 200)
            },
            next: function() {
